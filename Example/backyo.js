...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (buttonType) {
                const ButtonsArgs = getButtonArgs(message);
                ...
                stanza.content.push({
                    ...
                    content: [
                        {
                            tag: buttonType,
                            attrs: ButtonsArgs.arg,
                            content: ButtonsArgs.body
                        }
                    ]
                });
    ...
    const getButtonArgs = (message) => {
        console.log(message, 'argssssssss');
        if (message.templateMessage) {
            ...
            return{ 
             arg:{ v: '2', type: ListType[type].toLowerCase() },
             body: []
             }
        }
        else if (message.interactiveResponseMessage) {
            ...
            console.log(message.interactiveMessage, 'interactiveMessagessssss');
            return {
                arg:{
                type: "native_flow",
                v: "1"
                ...
                body:[{
                    tag: 'native_flow',
                    content: [],
                    attrs: { name: 'payment_info' }
                }]
                
            };
        }
        
        else if (message.interactiveMessage.nativeFlowMessage.buttons[0].name === 'quick_reply') {
        ...
        else if (message.interactiveMessage.nativeFlowMessage.buttons[0].name === 'cta_copy') {
        ...
        else if (message.interactiveMessage.nativeFlowMessage.buttons[0].name === 'cta_url') {
        ...
        else if (message.interactiveMessage.nativeFlowMessage.buttons[0].name === 'cta_call') {
